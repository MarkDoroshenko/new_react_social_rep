...
let store = {
    _state: {
        ...
        messagesPage: {
            dialogs: [
                { id: 1, name: 'Alex', avatar: "https://klike.net/uploads/posts/2019-03/1551511845_24.jpg" },
                { id: 2, name: "Igor", avatar: "https://klike.net/uploads/posts/2022-06/1654494304_7.jpg" },
                {
                    id: 3,
                    name: 'Joseph',
                ...
                { id: 4, name: "Kiril", avatar: "https://klike.net/uploads/posts/2022-08/1661144189_10.jpg" },
                { id: 5, name: 'Natali', avatar: "https://klike.net/uploads/posts/2019-03/1551511862_48.jpg" },
                {
                    id: 6,
                    name: "Kate",
    ...
    dispatch( action ) {
        if ( action.type === 'ADD-POST' ) {
            let newPost = {
                id: 5,
                message: this._state.profilePage.newPostTextIn,
                likesCount: 6,
            };
            this._state.profilePage.posts.push( newPost );
            this._state.profilePage.newPostTextIn = '';
            this._callSubscriber( this._state );

        } else if ( action.type === 'UPDATE-NEW-POST-TEXT' ) {
            this._state.profilePage.newPostTextIn = action.newText;
            this._callSubscriber( this._state );

        } else if ( action.type === 'ADD-MESSAGE' ) {
            let newMessage = {
                id: 7,
                message: this._state.messagesPage.newMessageTextIn,
                name: 'You',
                avatar: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYUfbUNJrtXWHm5PrsKkvgbSm2XaRgX4tVhg&usqp=CAU',
            };
            this._state.messagesPage.messages.push( newMessage );
            this._state.messagesPage.newMessageTextIn = '';
            this._callSubscriber( this._state );

        } else if ( action.type === 'UPDATE-NEW-MESSAGE-TEXT' ) {
            this._state.messagesPage.newMessageTextIn = action.newText;
            this._callSubscriber( this._state );
        }
    }
}
